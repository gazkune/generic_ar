...
@author: gazkune Probando probando
"""
...
def main(argv):   
    ...
    #for train, test in skf.split(X, y_index):
        ...
        # NOTE: First attempt using SUM yields negative cosine_proximity; could be because the sum makes some values greater than one?
